export default function Editor({
  ...
  <div class="editor-toolbar">
    ...
    <select id="text-color-picker">
      <option value="black" style="color: black;">Default</option>
  ...
  <div class='editor_content' name="content" contentEditable="true" data-placeholder="여기에 내용을 입력해주세요" style="min-height: 200px; border: 1px solid #ccc; padding: 10px;"></div>
`;
